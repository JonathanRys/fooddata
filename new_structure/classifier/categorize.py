...
stems_by_category = {
    ('alcohol', "catagorizer/catagories/final_roots_ALCOHOL.txt"),
    ('carcinogen', "catagorizer/catagories/final_roots_CARCINOGENS.txt"),
    ('fruit', "catagorizer/catagories/final_roots_FRUITS.txt"),
    ('mushroom', "catagorizer/catagories/final_roots_MUSHROOMS.txt"),
    ('rennet', "catagorizer/catagories/final_roots_RENNET.txt"),
    ('shellfish', "catagorizer/catagories/final/final_roots_SHELLFISH.txt"),
    ('vegetable', "catagorizer/catagories/final/final_roots_VEGETABLES.txt")
}
